...
export default function NavBar2() {
    ...
    return (
        ...
        <a className=" fixed overflow-hidden  flex items-center justify-center   h-8 pr-2 pl-1 bg-[#F9F5FD] rounded-full sm:bottom-[2.5rem] sm:top-auto top-[670px] sm:right-14 right-6  mr-4 mb-4 border border-[#E1B9FD]  text-purple-800 hover:bg-purple-100 z-50" href="http://wa.me/91956019070" target="_blank" rel="noreferrer">
