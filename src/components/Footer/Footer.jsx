...
const Footer = () => {
  return (
    <div className="bg-purple-50 pt-10 pl-5 sm:pl-0 overflow-hidden">
      <hr className="border sm:block hidden sm:max-w-[100%-40px] sm:w-[1199px] m-auto w-[375px] max-w-[100%]  dark:bg-[#8D2ED1]"></hr>
      <div className="flex flex-col justify-between pb-32  bg-purple-50   sm:max-w-[100%-40px] sm:w-[1199px] m-auto w-[375px] max-w-[100%]  sm:flex sm:flex-row  ">
