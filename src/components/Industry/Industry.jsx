  ...
  return (
    ...
    <div className="flex flex-col-reverse mt-5 sm:mt-6 sm:flex sm:flex-row md:ml-40 sm:ml-40 h-auto" >
        <div className="left w-auto sm:w-2/5" >
            <h2 className="text-2xl font-medium sm:text-3xl leading-loose sm:leading-relaxed ml-5 sm:ml-0">Diverse Range of Specialty Chemicals</h2>
            <p className="font-medium text-sm sm:text-lg whitespace-pre-wrap text-gray-500   gap-3 tracking-normal mt-4 float-left leading-loose sm:leading-loose ml-5 sm:ml-0">Explore Molequle`s <span className="text-purple-600 leading-loose ">vast product portfolio,</span> ranging from APIs & Excipients in Pharma to Polymers in Plastics, encompassing a comprehensive range of industrial and specialty chemicals. <br />
    ...
    <div className="left  mr-8 sm:ml-0 ml-5">
        ...
        <div className="right w-auto sm:w-2/5 ml-6 mt-10 sm:mt-1" >
            ...
            <p className="font-medium text-sm sm:text-lg  text-gray-500  gap-3  mt-4 float-left leading-loose sm:leading-loose ">Derisk your supply chain by leveraging our expertise in crossborder sourcing. Place your trust in Molequle to procure top-quality products from our esteemed network of suppliers.</p>
    ...
    <div className="flex flex-col-reverse  sm:mt-28 sm:flex sm:flex-row md:ml-40 sm:ml-40 h-auto mt-20" >
        <div className="left w-auto sm:w-2/5" >
            <h2 className="text-xl mt-10 sm:mt-20 font-medium sm:text-3xl leading-relaxed sm:leading-relaxed ml-5 sm:ml-0 ">Credit support and post-sale service</h2>
    ...
    <div className="w-auto bg-purple-50 mt-20 h-auto" style={{ padding:"3% 10% 4% 10% ", height:"auto"}}>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-4 mt-6">
            ...
            <div className="first" style={{height:"236px" , width:"265px"}}>
                <img src="./Group 487366.svg" alt="first" />
                <h2 className="text-base sm:text-xl font-medium mt-5">Formulation</h2>
                <p className="font-normal text-sm sm:text-lg whitespace-pre-wrap text-gray-600  gap-3 tracking-normal mt-2 float-left"> In-house formulation to ensure equivalent grades compatible to current process</p>
            </div>
            {/* value chain second card */}
            <div className="second"style={{height:"236px" , width:"265px"}}>
            ...
            <div className="third"style={{height:"236px" , width:"265px"}}>
            ...
            <div className="fourth"style={{height:"236px" , width:"265px"}}>
    ...
    <div style={{margin:"5% 10% 2% 10%"} }>
        ...
        <div className="grid grid-cols-3 -gap-5 sm:grid-cols-5 mt-10 sm:mt-10 mb-5 ">
