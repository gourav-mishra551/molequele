export const items = [
    ...
    {
        status: "inactive",
        imgSrc: "./Ellipse 74 (1).png",
        name: "V. Khanna",
        position: "Ankleshwar, Gujarat", 
        quote: "We have been supplying to Molequle for long time and faced no challenge till now. They have clear requirements, operationally active and make timely payments. "
    },
    {
        status: "inactive",
